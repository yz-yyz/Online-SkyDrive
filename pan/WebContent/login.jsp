...
<head>
    ...
    <title>Online SkyDrive Login</title>
...
<body>
    <div class="header">
        ...
        <p id="welcomep">Welcome &nbsp <span style="color:blue"> Online SkyDrive </span>！！！</p>
    </div>
    <div class="center">
        <div id="box">
        ...
        <div class="login">
            <div>
                <p id="p1">账号密码登录</p>
                <form action="DoLogin" method="post" name="from1">
                    <p id="p2">
                        <input type="text" name="username" placeholder="用户名" class="ipt">
                    </p>
                    <p id="p3">
                        <input type="password" name="password" placeholder="密码" class="ipt">
                    </p>
    ...
    <div class="blocks">
        <div class="notice">
            ...
            <p id="gg">
                公告：我们的功能在逐步上线，敬请期待 &nbsp↓&nbsp↓&nbsp↓
            </p>
        </div>
